...
select current_timestamp + (individual.id * interval '100 second')/(select max(id) from individual),
    ...
    where individual.observations ->> 'c9e64f06-23ac-47dc-b7e4-c93b819f52ce' in (
        ...
        '08592112',
        '10290809',
        '10361710') and individual.is_voided = false
order by 1;
...
where individual.observations ->> 'c9e64f06-23ac-47dc-b7e4-c93b819f52ce' in ('08110307',
                                                                             '08110308',
                                                                             '08592112',
                                                                             '10290809',
                                                                             '10361710'
...
where program_enrolment.audit_id = audit.id
  ...
  and individual.observations->>'c9e64f06-23ac-47dc-b7e4-c93b819f52ce' in ('08110307',
                                                                           '08110308',
                                                                           '08592112',
                                                                           '10290809',
                                                                           '10361710'
