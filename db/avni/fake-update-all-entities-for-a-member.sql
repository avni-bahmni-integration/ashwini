...
select current_timestamp + (individual.id * interval '1000 second')/(select max(id) from individual),
    ...
    from individual
    where individual.observations ->> 'c9e64f06-23ac-47dc-b7e4-c93b819f52ce' in ('09272118',
                                                                                 '09272120',
                                                                                 '11540303',
                                                                                 '11023806',
                                                                                 '11070508',
                                                                                 '11223705') and individual.is_voided = false
order by 1;
...
where program_enrolment.individual_id = individual.id
  and individual.observations->>'c9e64f06-23ac-47dc-b7e4-c93b819f52ce' in ('09272118',
                                                                           '09272120',
                                                                           '11540303',
                                                                           '11023806',
                                                                           '11070508',
