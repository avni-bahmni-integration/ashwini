...
insert into mapping_metadata (mapping_group_name, mapping_name, bahmni_value, avni_value)
values ('PatientSubject', 'Concept', 'c283a983-5db0-42b7-aa60-8ced1734eae6', 'Registration date');
...
insert into mapping_metadata (mapping_group_name, mapping_name, bahmni_value, avni_value)
values ('PatientSubject', 'Concept', 'b09be3d4-644e-487b-bc1c-d1eea88de25d', 'Date of birth');
